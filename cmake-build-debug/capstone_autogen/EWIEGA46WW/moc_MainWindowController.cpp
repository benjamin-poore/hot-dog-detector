...
QT_MOC_LITERAL(1, 21, 22), // "uploadButtonController"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 13) // "handleResults"

    },
    "MainWindowController\0uploadButtonController\0"
    "\0handleResults"
};
...
void MainWindowController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->uploadButtonController((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MainWindowController::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindowController::uploadButtonController)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainWindowController::uploadButtonController(const QString & _t1)
{
